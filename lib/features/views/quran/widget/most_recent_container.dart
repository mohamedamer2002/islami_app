          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              return  GestureDetector(
                onTap:(){
                  Navigator.pushNamed(context, AppRoutes.quranDetails,arguments: SuraDetailsModel(mostRecentIndex: mostRecentList[index],
                   mostRecentKey: widget.key as GlobalKey<MostRecentContainerState>));
                } ,
                child: Container(
...
// import 'package:islami_app/core/utils/shared_preference.dart';
// import 'package:islami_app/features/views/quran/quran_resourses.dart';
// import 'package:islami_app/features/views/quran/quran_view.dart'; // لو SuraDetailsModel هنا
...
//   int _selectedIndex = 0; // لتخزين آخر تاب مضغوط
//   int get selectedIndex => _selectedIndex; // getter للوصول من برة
...
//                 return GestureDetector(
//                   onTap: () {
//                     // _selectedIndex = mostRecentList[index]; 

//                     Navigator.pushNamed(
//                       context,
//                   AppRoutes.quranDetails,
//                       arguments: SuraDetailsModel(
//                         mostRecentIndex: _selectedIndex,
//                         mostRecentKey: widget.key as GlobalKey<MostRecentContainerState>,
//                       ),
//                     );
//                   },
...
//                           children: [
//                             Text(
//                               QuranResourses.englishQuranSurahs[mostRecentList[index]],
//                               style: AppTextStyles.black24W700,
//                             ),
//                             Text(
//                               QuranResourses.arabicAuranSuras[mostRecentList[index]],
//                               style: AppTextStyles.black24W700,
//                             ),
//                             Text(
//                               "${QuranResourses.ayaNumber[mostRecentList[index]]} Verses",
